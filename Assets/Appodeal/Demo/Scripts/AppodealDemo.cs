...
namespace ConsentManager.ConsentManagerDemo.Scripts
{
    ...
    public class AppodealDemo : MonoBehaviour, IAppodealInitializationListener, IInAppPurchaseValidationListener,
        IRewardedVideoAdListener, IConsentFormListener, IConsentInfoUpdateListener
    {
        #region Constants
...
#elif UNITY_ANDROID
        public static string appKey = "10fbc7923ab03e02ee9560f1465f35198b06267980859c67";
#elif UNITY_IPHONE
        ...
        private void Start()
        {
            ...
            btnShowRewardedVideo.GetComponentInChildren<TMP_Text>().text = CACHE_REWARDED_VIDEO;
        ...
        public void PrintCurrentConsent()
        {
            ...
            Debug.Log("consent.hasConsentForVendor() - " +
        ...
        {
            Appodeal.setLogLevel(true ? Appodeal.LogLevel.Verbose : Appodeal.LogLevel.None);
        ...
        public void onInitializationFinished(List<string> errors)
        {
            ...
            Appodeal.logEvent("test_event",
                new Dictionary<string, object> { { "test_key_1", 42 }, { "test_key_2", "test_value" } });
        }
        ...
        public void onRewardedVideoLoaded(bool isPrecache)
        {
            ...
            btnShowRewardedVideo.interactable = true;
        ...
        {
            btnShowRewardedVideo.GetComponentInChildren<TMP_Text>().text = "CACHE REWARDED VIDEO";
            btnShowRewardedVideo.interactable = false;
